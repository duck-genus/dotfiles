...
includes packages from AUR - **vscode, figlet, lolcat, neovim, lsd, brave, dmenu, i3-wm, ly, lf, feh, kitty, some fonts, fastfetch, xorg packages, brightnessctl** and some themes.
